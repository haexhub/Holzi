...
@pytest.fixture
def configure_roots():
    """Seed the `workspaces` table for the Plan-13/24 git tests (Plan 25-A).

    Mirrors `tests/test_api_workspace.py`'s fixture: comma-separated slug
    list in, DB rows seeded, each slug uses itself as `display_name`.
    """
